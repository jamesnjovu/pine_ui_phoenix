defmodule PineUi do
  ...
  ## Examples
      ...
      <PineUi.typing_effect text_list={Poison.encode!(["I'm here james", "All mightily push"])} />
  """
  def typing_effect(assigns) do
    assigns =
      assign_new(assigns, :text_list, fn -> Poison.encode!(["Alpine JS is Amazing", "It is Truly Awesome!", "You Have to Try It!"]) end)
